...
const sessdata = config.SESSION_ID.split("𝐌𝐈𝐓𝐙𝐈-𝐌𝐃=")[1];
...
console.log("Connecting 𝐌𝐈𝐓𝐙𝐈-𝐌𝐃 Bot.....🔥");
...
let up = `*Connecting 𝐌𝐈𝐓𝐙𝐈-𝐌𝐃 Multidevice Whatsapp Bot ...💾*
...
conn.sendMessage(conn.user.id,{ image: { url: `https://i.ibb.co/LhX6KHW7/SulaMd.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("94726561647")){
if(isReact) return
m.react("👨‍💻")
}
